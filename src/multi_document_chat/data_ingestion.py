...
class DocumentIngestor:
    ...
    def __init__(self,temp_dir:str = "data/multi_doc_chat",faiss_dir: str = "faiss_index",session_id :str | None = None):
        try:
            ...
            self.log.error("failed to inialise DocumentIngestor",error=str(e))
    ...
    def ingest_files(self,uploaded_files):
        try:
            ...
            for uploaded_file in uploaded_files:
                ...
                self.log.info("file save for ingestion",filename=uploaded_file.name,saved_as=str(temp_path),session_id = self.session_id)    
            ...
            self.log.info("All document loaded",total_doc=len(documents),session_id=self.session_id) 
